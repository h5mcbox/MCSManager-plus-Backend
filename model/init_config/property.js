...
//Challenge-Response密钥
//请在第一次启动后将此字符串修改为随机字符
MCSERVER.localProperty.MasterSalt="";

//Chellenge-Response有效期(单位s)
//数字签名登录的签名有效期
MCSERVER.localProperty.ChallengePeriod=30;

//权限配置表
MCSERVER.localProperty.rights={
