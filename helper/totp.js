(function(global,factory){
  if(typeof module==="object"&&typeof module.exports==="object"){
...
})(typeof window==="object"?window:this,function totp(){
    var Crypto = {};
    ...
    function group(data,l){
        var result=[],i=0;
        for(i=0;i<data.length;i+=l){
    ...
    function hotp(key,count,digit=6){
        var t5=[];
        var t0=group(Crypto.sha1_hmac((
          intToBytesArray(count).forEach(e=>t5.push(String.fromCharCode(e))),
          t5
        ).join(""),key),2).map(e=>parseInt(e,16));
        var t1=t0[19]&15;
